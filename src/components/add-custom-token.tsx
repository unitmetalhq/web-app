...
export default function AddCustomToken({
  ...
  const { data, isLoading, isFetching } = useReadContracts({
    contracts: queryAddress
      ? [
          { address: queryAddress, abi: erc20Abi, functionName: "name",     chainId },
          { address: queryAddress, abi: erc20Abi, functionName: "symbol",   chainId },
          { address: queryAddress, abi: erc20Abi, functionName: "decimals", chainId },
        ]
      : [],
